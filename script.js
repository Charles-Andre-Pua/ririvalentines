...
const noPhrases = ["Huh unsay no?", "Tarong ba? Di naka ganahan nako?", "Sig bugalbugal bebe mo hilak ko ron 😢", "So di jud diay ko nimo lab 💔😭"];
const yesPhrases = ["Love diay ko nimo??", "Weeeehhhhhh???!", "PROMISE?? love ko nimo?"];

const failedGif = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcG9nNG4yaGR0M2g2Y2NoMHB6MWc3dmZvb2Z5b2poeWRieHhjYWI3OCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/7AzEXdIb1wyCTWJntb/giphy.gif";
...
yesBtn.addEventListener('mouseover', () => { 
    if (moveCount < maxMoves) {
        ...
        setTimeout(() => { // Small delay to let the fixed position register
            const padding = 80;
...
// 3. SUCCESS TRIGGER
if (yesBtn) {
    yesBtn.addEventListener('click', () => {    localStorage.setItem('valentineSuccess', 'true'); // Optional flag
